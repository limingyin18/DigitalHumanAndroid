...
void CameraNDK::create(ANativeWindow *window)
{
    // open camera
    {
        ...
        if (status == ACAMERA_OK) {
            ...
            __android_log_print(ANDROID_LOG_WARN, "pirate", "Unsupported ACAMERA_SENSOR_INFO_EXPOSURE_TIME_RANGE");
        ...
        if (status == ACAMERA_OK){
            ...
            __android_log_print(ANDROID_LOG_WARN, "pirate", "failed for ACAMERA_SENSOR_INFO_SENSITIVITY_RANGE");
